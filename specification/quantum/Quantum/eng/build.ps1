...
try {
    ...
    $newVersion = "2024-02-01-preview"
    $oldVersion = "2023-11-13-preview"

    $jsonFile = Resolve-Path "../data-plane/Microsoft.Quantum/preview/$newVersion/quantum.json"
    $jsonFilePrevious = Resolve-Path "../data-plane/Microsoft.Quantum/preview/$oldVersion/quantum.json"
    ...
    RunAndCheck "lint-diff" \ {
        autorest --v3 --spectral --azure-validator --use=@microsoft.azure/openapi-validator@2.1.4 --tag="package-$newVersion" $configFile
    }
